...
### 6. UpdateMemberRequest
**File**: `app/Http/Requests/ChatMember/UpdateMemberRequest.php`
...
- `readChatFile()` - Get chat file (photo...)
...
- `createMessage()` - Send new message (text, image, video, audio, file)
...
- `GET /api/chats/read/{chatId}/{folder}/{filename}` - Get chat file (photo...)
...
- Message CRUD operations (text, image, video, audio, file)
