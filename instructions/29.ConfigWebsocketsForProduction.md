...
Update the Dockerfile to include optimizations for uploads:
...
### 1.2 docker-compose.prod.yml (Production Configuration)
...
server {
    ...
    # File upload limits for 4GB VPS
    ...
    location /api/ {
        ...
        # Optimize for file uploads on limited resources
