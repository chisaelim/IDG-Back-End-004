...
For production applications, consider implementing OAuth2 instead of app passwords:

1. Install Laravel Socialite
2. Configure Google OAuth2
3. Use refresh tokens for email sending

### Testing Email Configuration

Test your email configuration with Tinker:
...
class AuthController extends Controller
{
    ...
    function signout(Request $request)
    {
        ...
        // method 1: Revoke current token only
